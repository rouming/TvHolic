...
int HandleCmds::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
	...
	if (_c == QMetaObject::InvokeMetaMethod) {
		...
		case 2:
			...
			break;
		case 3:
			setLight((*reinterpret_cast< int(*)>(_a[1])));
			break;
		case 4:
			turnOn();
			break;
...
int ControlPoint::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
	...
	if (_c == QMetaObject::InvokeMetaMethod) {
		...
		case 7:
			...
			break;
		case 8:
			setTargetResponse((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])));
			break;
		case 9:
			getTargetResponse((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])));
			break;
		case 10:
			getStatusResponse((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])));
			break;
		case 11:
			onNewDevice((*reinterpret_cast< BrisaControlPointDevice*(*)>(_a[1])));
			break;
		case 12:
			onRemovedDevice((*reinterpret_cast< QString(*)>(_a[1])));
			break;
		}
		_id -= 13;
	}
